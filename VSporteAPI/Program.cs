...
app.Run();
//To Do:
//ПРоверка существования игрока/клуба вво всех сервисах, связанных с матчевентом+
// ПРоверить, что  игрок может состоять в двух клубах +
// Настроить not found на getById